...
function vtkResliceCursorRepresentation(publicAPI, model) {
  ...
  publicAPI.updateReslicePlane = () => {
    ...
    // model.planeSource.setPoint1(boundedP1);
    // model.planeSource.setPoint2(boundedP2);
    //
  ...
  publicAPI.setResliceParameters = (
    ...
    if (model.reslice) {
      ...
      console.log(
        publicAPI.getCursorAlgorithm().getReslicePlaneNormal(),
        model.imageActor.getBounds(),
        model.resliceAxes
      );
    }
  };
